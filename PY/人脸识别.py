...
def faceDetect(imgBase64):
    ...
    data = {"image": imgBase64, "image_type": "BASE64",
...
if __name__ == "__main__":
    ...
    #   print(text+'1')
    # 调用文字识别服务
    result = faceDetect(urllib.parse.urlencode(
    ...
    cv2.putText(img, "gender:" + gender.encode("utf-8"),
                (0, 40), font, 0.5, (200, 255, 255), 1)
    cv2.putText(img, "beauty:" + str(beauty), (0, 60),
                font, 0.5, (200, 255, 255), 1)
    cv2.putText(img, "expression:" + str(expression),
                (0, 80), font, 0.5, (200, 255, 255), 1)
