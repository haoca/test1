...
cookies = {
    'value': 'LIVE_BUVID=AUTO9615869423079259; _uuid=267B3654-2F82-EA1D-74A9-B7EB399F2FB167234infoc; PVID=1'}
...
# # 找到签到点击完成签到
driver.find_element_by_class_name('nav-search-keyword').click()

driver.find_element_by_class_name('btn-login:hover').click()
driver.find_element_by_xpath(
    '/html/body/div/div/div[2]/div[3]/div[3]/div/div/div/div[5]/a[1]').click()
# driver.close()
driver.find_element_by_id('login-username').send_keys(password)
time.sleep(1)
